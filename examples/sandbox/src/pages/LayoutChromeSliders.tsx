...
> = {
  ...
  "field-label-control-gap": {
    labelKey: "layoutChrome.fieldLabelControlGap",
    hintKey: "layoutChrome.fieldLabelControlGapHint",
    max: 24,
  },
  "field-hint-gap": {
...
> = {
  ...
  "field-header-action-row-min-height": {
    labelKey: "layoutChrome.roFieldHeaderActionRowMin",
    hintKey: "layoutChrome.roFieldHeaderActionRowMinHint",
  },
  "stats-min-col-sm": {
