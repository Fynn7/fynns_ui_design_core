...
const en = {
  ...
  "globals.chatComposerThinkingToggleHelp": "Recipe (≥ 0.5.291): wide host — Model Menu → Thinking → Vision → Send with labeled ChatComposerToggle pills + Tooltip. Do not bury modes in + Menu. Live #sandbox-chat-composer-thinking-toggle.",
  "globals.chatComposerThinkingToggleNarrowHelp": "Recipe (≥ 0.5.291): ~365px host — same endActions recipe; core ≤26rem hides toggle labels (icon-only; Tooltip + aria-label). Live #sandbox-chat-composer-thinking-toggle-narrow.",
...
const zh: Record<MessageKey, string> = {
  ...
  "globals.chatComposerThinkingToggleHelp": "配方（≥ 0.5.291）：宽壳 — Model → Thinking → Vision → Send，带标签 ChatComposerToggle + Tooltip。勿埋进 + 菜单。活样 #sandbox-chat-composer-thinking-toggle。",
  "globals.chatComposerThinkingToggleNarrowHelp": "配方（≥ 0.5.291）：~365px 窄壳 — 同一 endActions 配方；core ≤26rem 隐藏 pill 文案（仅图标；Tooltip + aria-label）。活样 #sandbox-chat-composer-thinking-toggle-narrow。",
