...
const en = {
  ...
  "globals.infoHintNarrowLabel": "Hide built-ins",
  "globals.infoHintNarrowSwitch": "Hide built-in sample entries",
  "globals.infoHintNarrowBody": "Sample tip for a narrow ControlRow — keep the tip on the label, Switch alone in controls.",
  "globals.infoHintNarrowAria": "About hide built-ins",
  ...
  "globals.chatComposerModelLocalSample": "llama3.2:latest",
  "globals.chatComposerModelCloudSample": "sample-cloud-flash",
  "globals.chatComposerModelCliCursor": "Cursor Agent",
  "globals.chatComposerModelCliCodex": "Codex",
  "globals.chatComposerModelCliClaude": "Claude Code",
...
const zh: Record<MessageKey, string> = {
  ...
  "globals.infoHintNarrowLabel": "隐藏内置",
  "globals.infoHintNarrowSwitch": "隐藏内置示例条目",
  "globals.infoHintNarrowBody": "窄 ControlRow 样例说明 — tip 挂在标签尾，Switch 单独在右侧。",
  "globals.infoHintNarrowAria": "关于隐藏内置",
  "globals.infoHintHelp":
  ...
  "globals.chatComposerModelSectionsHelp": "配方（≥ 0.5.290）：模型 Menu 用 DropdownMenuGroup 分 Local / Cloud / CLI，分区之间 Separator。仅当该源已配置（密钥 / 本地端点 / CLI 凭据文件）才渲染该分区；未配置则整段省略。三者皆无 → 禁用「暂无可用模型」。活样 #sandbox-chat-composer-model-sections / #sandbox-chat-composer-model-empty。",
  "globals.chatSend": "发送",
