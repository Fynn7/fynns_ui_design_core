...
const en = {
  ...
  "globals.chatComposerThinkingToggleHelp": "Recipe (≥ 0.5.289): put ChatComposerToggle mode pills in endActions — Model Menu → Thinking → Vision → Send. Tooltip for the tip copy. Do not bury modes in the leading + Menu. Live #sandbox-chat-composer-thinking-toggle.",
...
const zh: Record<MessageKey, string> = {
  ...
  "globals.chatComposerThinkingToggleHelp": "配方（≥ 0.5.289）：ChatComposerToggle 放 endActions — 模型 Menu → Thinking → Vision → Send；Tooltip 写提示文案。勿把模式埋进 leading + 菜单。活样 #sandbox-chat-composer-thinking-toggle。",
