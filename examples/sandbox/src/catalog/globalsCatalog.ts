...
export const GLOBALS_DEMOS: readonly GlobalsDemoEntry[] = [
  ...
  },
  {
    ...
    keywords: ["导航轨", "rail", "navrail"],
  },
  {
    id: "navigation-bar",
    categoryId: "navigation",
    label: "NavigationBar",
    keywords: ["底部导航", "navbar", "navigation bar"],
  },
  {
  ...
  },
  {
    id: "shell",
    categoryId: "navigation",
    label: "ClippedNavShell",
    keywords: ["壳", "shell", "clipped", "layout shell"],
  },
  {
    id: "bottom-app-bar",
    categoryId: "navigation",
  ...
  },
  {
    ...
    keywords: ["节奏", "controlstack", "controlrow", "toolbar rhythm", "layout"],
  },
  {
    id: "swatches",
    categoryId: "swatches",
