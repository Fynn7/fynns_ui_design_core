...
const LAYOUT_KEY_ROLES: Record<EditableLayoutKey, string> = {
  ...
  "action-cluster-gap":
    "Action footers · labeled Buttons in end-align cluster / dialog foot (8dp)",
  "chrome-icon-gap":
  ...
  "scroll-edge-fade-length":
    "Scroll-edge fade · CodeBlock / Textarea / PageScroll / FillColumn header / NavigationDrawer body soft mask (data-fade-top/bottom)",
  "list-well-max-height":
