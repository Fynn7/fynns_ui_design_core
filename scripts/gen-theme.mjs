 ...
 * src/theme/overlayScrollbar.ts (absolute rail; pointer-events none).
...
/* Positioning context for absolute overlay rails (only when UA position is static). */
