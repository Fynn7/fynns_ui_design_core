...
export type NavigationDrawerProps = {
   ...
   * Body gap = `--fynns-navdrawer-section-gap` (same as Group leaf rows).
   * Do **not** wrap in `.fynns-unit-stack` (16dp form/unit rhythm).
   */
  children?: ReactNode;
};
 ...
 * — never `.fynns-unit-stack` for destination lists.
