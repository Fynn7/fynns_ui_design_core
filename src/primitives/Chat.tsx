 ...
 * bottom toolbar when expanded; collapsed keeps a single ~44dp row via
 * toolbar `display: contents` (32dp controls + 6dp pad — Cursor-dense
 * circle; not SearchBar 56dp).
