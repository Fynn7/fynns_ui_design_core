...
> Read on demand — when writing docs, naming things, or deciding *which* primitive a screen calls for.
> Implementation authority and hard rules: [`../AGENTS.md`](../AGENTS.md) → `docs/DESIGN_SYSTEM.md`.

Shared visual dialect: what a screen *is*, not how React/CSS implements it.

## Parties and vocabulary
