...
| `UnitStack` | `.fynns-unit-stack` or Card / Collapsible body (built-in `unit-stack-gap`). Control + its note → `ControlBlock`, not a revived stack component. Sandbox demos may still use `.sandbox-stack`. |
