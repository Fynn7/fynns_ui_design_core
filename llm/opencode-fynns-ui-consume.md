...
4. Do **not** invent a long task file; the consume contract + AGENTS/sandbox are the source of truth. If the keep-set cannot meet the ask, tell the user to implement in `fynns_ui_design_core` first.
