...
- **DON'T** leave **`IconButton` `loading`** showing the spinner **and** the
  glyph in the same disk (spinner + refresh overlap). Core ≥ **0.5.77** renders
